...
function EventComponent({event, onEventClick, onEventDelete, isAdmin}) {
        ...
        <div className='col-md-4'>
            <div className='card bg-light' style={{ margin: '0.7rem 0 0.7rem 0' }}>
                <div className='card-body'>
                    ...
                    <Link className={isWorking ? 'btn btn-secondary disabled' : 'btn btn-secondary' } to={"/event"} onClick={e => onEventClick(event)}>Details</Link>
                    {
                        isAdmin &&
                        <> 
                            {
