...
function StudentEventNavbar(props) {
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-white" style={{ padding: '0.5rem' }}>
                <div style={{ display: 'flex', flex: 1, justifyContent: 'flex-start', alignItems: 'center' }}>
                    ...
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                            <Link to={`/student?stud=${props.selectedAccount}`} className="nav-link">My Courses</Link>
                        </li>
                    </ul>
                </div>
            </nav>
...
export default withRouter(connect(mapStateToProps)(StudentEventNavbar))